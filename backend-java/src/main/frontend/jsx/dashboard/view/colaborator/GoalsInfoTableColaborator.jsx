          ...
          <table className="dashboard-table table goals-dashboard-table">
              <thead>
                <tr>
                    ...
                    <th id = "column-goals-perfomance">Vencimento
                    ...
                    <th id = "column-goals-perfomance">Esperado </th>

                    <th id = "column-goals-perfomance">Alcançado                    
              ...
              <tbody>
                <tr> 
                  <td id = "GoalsInformationTable"> {this.state.indicator && this.state.indicator.aggregate ? "Indicador agregado não possui metas" : "Não há registros cadastrados"} </td>
                </tr>
             </tbody>
          </table>
        </div>
