          ...
          <table className="dashboard-table table goals-dashboard-table">
              <thead>
                <tr>
                    ...
                    <th id = "column-goals-perfomance">{Messages.get("label.goal")}                    
                    ...
                    <th id = "column-goals-perfomance">{Messages.get("label.maturity")}
                    ...
                    <th id = "column-goals-perfomance">{Messages.get("label.status")}</th>

                    <th id = "column-goals-perfomance">{Messages.get("label.goals.expected")} </th>

                    <th id = "column-goals-perfomance">{Messages.get("label.reached")}                    
              ...
              <tbody>
                <tr> 
                  <td id = "GoalsInformationTable"> {this.state.indicator && this.state.indicator.aggregate ? Messages.get("label.aggIndicatorHaveNoGoals") : Messages.get("label.noRegister")} </td>
                </tr>
             </tbody>
          </table>
        </div>
                            ...
                            <tr key={"goal-"+idx} name={"goal-"+idx}>
                              ...
                              <td className="fdpi-table-cell">{goal.deadLineStatus == 3 ? 
                                ...
                                <div className = "inDayGoalInfo">{goal.goalStatus} </div>}
                                 Última atualização: {goal.lastModification}</td>
