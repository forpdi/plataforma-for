...
/**
 * <p>Classe Java de execucaoOrgaoDTO complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="execucaoOrgaoDTO">
 *   &lt;complexContent>
 ...
 *         &lt;element name="unidadeOrcamentaria" type="{http://servicoweb.siop.sof.planejamento.gov.br/}execucaoUnidadeOrcamentariaDTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "execucaoOrgaoDTO", propOrder = {
    "codigoOrgao",
    "unidadeOrcamentaria"
})
public class ExecucaoOrgaoDTO
    extends BaseDTO
{

    protected String codigoOrgao;
    @XmlElement(nillable = true)
    protected List<ExecucaoUnidadeOrcamentariaDTO> unidadeOrcamentaria;
     ...
     * {@link ExecucaoUnidadeOrcamentariaDTO }
     * 
     * 
     */
    public List<ExecucaoUnidadeOrcamentariaDTO> getUnidadeOrcamentaria() {
        if (unidadeOrcamentaria == null) {
            unidadeOrcamentaria = new ArrayList<ExecucaoUnidadeOrcamentariaDTO>();
        }
