...
export default React.createClass({
	...
	render() {
		...
		if (this.props.vizualization) {
			if (this.props.fieldDef.type == AttributeTypes.INDICATOR_TYPE){
				...
				if(this.props.fieldDef.description != null){
					fieldEl = (
						<div><span className="pdi-normal-text" dangerouslySetInnerHTML={{__html: this.props.fieldDef.description}} style={{"display": "unset"}}/>
		...
		return (!!this.props.undeletable || !!this.props.alterable ? (
			...
			<div className={"form-group-sm" + (this.props.fieldDef.type == 'hidden' ? " hidden":"")}>
				{fieldEl}
