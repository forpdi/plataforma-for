...
import DashboardColaboratorView from "forpdi/jsx_forrisco/dashboard/view/DashboardColaboratorView.jsx";
import DashboardManagerView from "forpdi/jsx_forrisco/dashboard/view/DashboardManagerView.jsx";
				...
				{(
                    <div className="marginLeft30">
				        <span className = "marginRight20 marginBottom10">
                            <span className = "forrisco-nav-label">{Messages.getEditable("label.title.plan","forrisco-nav-label")}&nbsp;</span>
